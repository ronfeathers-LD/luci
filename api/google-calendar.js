/**
 * Vercel Serverless Function for Google Calendar
 * 
...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const { code, state, error: oauthError, userId, action, days, forceRefresh } = req.query;

    // Handle DELETE: Disconnect Google Calendar
