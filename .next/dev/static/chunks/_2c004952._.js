...
"[project]/src/components/shared/ServiceWorkerRegistrar.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
        ...
        "ServiceWorkerRegistrar.useEffect": ()=>{
            ...
            if ("TURBOPACK compile-time truthy", 1) {
                navigator.serviceWorker.getRegistrations().then({
                    "ServiceWorkerRegistrar.useEffect": (registrations)=>{
                        registrations.forEach({
                            "ServiceWorkerRegistrar.useEffect": (registration)=>{
                                registration.unregister().then({
                                    "ServiceWorkerRegistrar.useEffect": (success)=>{
                                        if (success) {
...
//# sourceMappingURL=_2c004952._.js.map