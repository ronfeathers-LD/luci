...
"[project]/src/lib/useAuth.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useAuth() {
        ...
        if (savedUser) {
            try {
                ...
                if (userData && userData.id && (!userData.roles || userData.roles.length === 0)) {
                    fetch(`/api/users?id=${userData.id}`).then((res)=>res.json()).then((data)=>{
                        if (data.roles) {
                            const updatedUser = {
                                ...userData,
                                roles: data.roles
    ...
    const handleSignOut = ()=>{
        ...
        if (("TURBOPACK compile-time value", "undefined") !== 'undefined' && window.google?.accounts?.id) //TURBOPACK unreachable
        ;
        // Track analytics
        if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
        ;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$useAuth$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/useAuth.js [app-ssr] (ecmascript)");
;
;
'use client';
;
...
const Dashboard = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$shared$2f$lib$2f$app$2d$dynamic$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(async ()=>{}, {
    loadableGenerated: {
        modules: [
...
function Home() {
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRouter"])();
    const { user, loading, handleSignIn, handleSignOut } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$useAuth$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        // Track page view
        if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
        ;
    ...
    if (!user) {
        const LoginPage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$shared$2f$lib$2f$app$2d$dynamic$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(async ()=>{}, {
            loadableGenerated: {
                modules: [
        ...
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(LoginPage, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2410394a._.js.map