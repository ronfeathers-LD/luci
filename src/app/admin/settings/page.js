...
const SystemSettingsPage = dynamic(() => import('../../../components/admin/SystemSettingsPage'), { ssr: false });
...
export default function AdminSettings() {
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined' && window.analytics) {
      window.analytics.pageView('/admin/settings');
    }
  ...
  return <SystemSettingsPage user={user} onSignOut={handleSignOut} />;
}
