...
const RoleManagementPage = dynamic(() => import('../../../components/admin/RoleManagementPage'), { ssr: false });
...
export default function AdminRoles() {
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined' && window.analytics) {
      window.analytics.pageView('/admin/roles');
    }
  ...
  return <RoleManagementPage user={user} onSignOut={handleSignOut} />;
}
